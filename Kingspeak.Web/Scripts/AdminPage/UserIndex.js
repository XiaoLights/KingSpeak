            ...
            columns: [{
                ...
                , formatter: function (value, row) {
                    ...
                    if (value == "1") {
                        ...
                        html += '<a href="javascript:void(0)" title="启用" onclick="userIndex.ChangeState(' + param + ')"><span class="label label-success">启用</span></a>';
                    }
                    else {
                        var param = "'" + row.UserId + "','1'";
                        html += '<a href="javascript:void(0)" title="禁用" onclick="userIndex.ChangeState(' + param + ')"><span class="label label-danger">禁用</span></a>';
                    }
                    return html;
                }
            }, {
